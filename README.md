...
_Dette repo beskriver og forklarer så kort som muligt både voksne og børn om [socket.io](https://socket.io/)_
...
## 👩‍🏫 For voksne
_En enkel forklaring uden teknisk baggrundsviden._
...
1. **[Node.js](https://nodejs.org/en)** — et program, der gør det muligt at køre JavaScript på computeren
